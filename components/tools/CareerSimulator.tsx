        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 space-y-8">
             <motion.div 
               ...
               className="w-16 h-16 border-4 border-[#02C39A]/20 border-t-[#02C39A] rounded-full"
             />
             <div className="text-center">
                <h4 className="text-xl font-bold mb-2">Analyzing Profile & Calculating ROI...</h4>
                <p className="text-[#6B7A8F] animate-pulse italic">Comparing against Indian market benchmarks...</p>
             </div>
          </div>
        ) : (
          <>
