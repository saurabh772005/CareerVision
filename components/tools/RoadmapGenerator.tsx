        ...
        <div className="bg-[#1A1F3A]/60 backdrop-blur-xl border border-white/10 p-12 rounded-[40px] shadow-2xl relative overflow-hidden">
           <div className="space-y-8">
              ...
              <button 
                ...
                className={`w-full py-6 rounded-3xl font-black text-xl transition-all shadow-xl flex items-center justify-center space-x-3 ${
                  generating ? "bg-white/10 animate-pulse text-[#02C39A]" : "bg-gradient-to-r from-[#028090] to-[#02C39A] text-white hover:scale-[1.02]"
                }`}
              >
