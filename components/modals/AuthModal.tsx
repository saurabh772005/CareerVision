      ...
      >
        ...
        <div className="p-10">
          <div className="flex flex-col items-center mb-10">
            ...
            <h2 className="text-2xl font-bold">{mode === 'signup' ? 'Join CareerCompass' : 'Welcome Back'}</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button 
              type="submit"
              disabled={loading}
              className={`w-full py-5 rounded-2xl font-black text-lg shadow-xl transition-all flex items-center justify-center space-x-2 ${
                loading ? "bg-white/10 animate-pulse" : "bg-[#02C39A] text-[#0A0E27] hover:shadow-[0_10px_30px_rgba(2,195,154,0.3)]"
              }`}
            >
